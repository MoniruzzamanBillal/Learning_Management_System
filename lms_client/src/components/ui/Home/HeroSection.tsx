...
const HeroSection = () => {
  return (
    <div className="HeroSectionContainer">
      <Wrapper className="HeroSectionWrapper flex flex-col sm:flex-row justify-between items-start sm:items-center gap-y-2 sm:gap-y-0 gap-x-0  sm:gap-x-3   ">
        {/* left section  */}
        <div className="leftSection w-full sm:w-[55%]  ">
          ...
          <p className="  mt-6 lg:mt-8 text-lg sm:text-base lg:text-lg w-[92%] sm:w-full md:w-[92%] xmd:w-[85%] lg:w-[70%]  ">
        ...
        {/* right section  */}
        <div className="rightSection w-[90%] sm:w-[45%]">
