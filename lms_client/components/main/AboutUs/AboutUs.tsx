      ...
      <Wrapper className="container mx-auto  ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16  ">
          <div className="md:order-1  ">
            ...
            <p className="text-gray-800 leading-relaxed">
              {
                " Since then, we've grown into a thriving community, constantly evolving our curriculum and teaching methods to stay ahead of industry trends. We believe that continuous learning is the key to success in the digital age, and we're here to guide you every step of the way."
              }
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            ...
            <p className="text-gray-800 leading-relaxed">
              {
                "We envision a future where continuous learning is seamless andimpactful. DevMats strives to be the leading platform for skill development, fostering a global community of learners and innovators who are ready to tackle tomorrow's challenges and contribute meaningfully to the tech landscape."
              }
            </p>
          </div>
        </div>
