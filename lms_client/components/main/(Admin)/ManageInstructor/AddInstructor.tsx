...
import { registerInstructorFunction } from "@/components/main/(Admin)/ManageInstructor/functions/auth.functions";
import { usePost } from "@/hooks/useApi";
import { addInstructorSchema } from "@/components/main/(Admin)/ManageInstructor/schema/User.schemas";
      ...
      <div className="AddInstructorContainer py-8 bg-gray-100 border border-gray-300 p-3 shadow rounded-md">
        <div className="AddInstructorWrapper">
          ...
          <div className="addNewInstructorForm p-1 w-[98%] xsm:w-[92%] sm:w-[85%] md:w-[80%] xmd:w-[75%] lg:w-[65%] m-auto ">
            <form
              onSubmit={handleSubmit(handleAddInstructor as any)}
