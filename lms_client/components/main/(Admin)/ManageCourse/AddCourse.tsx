...
import { addCourseFunction } from "@/components/main/(Admin)/ManageCourse/functions/course.functions";
import { useFetchData, usePost } from "@/hooks/useApi";
import { addCourseValidationSchema } from "@/components/main/(Admin)/ManageCourse/schema/Course.schemas";
...
const AddCourse = () => {
  ...
  const { mutateAsync: addNewCourse, isPending: isLoading } = usePost([
    ["all-courses-admin"],
  ]);
      ...
      <div className="AddCourseContainer py-8 bg-gray-100 border border-gray-300 p-3 shadow rounded-md ">
        <div className="addCourseWrapper">
          ...
          <div className="addCourseForm p-1 w-[98%] xsm:w-[92%]  m-auto ">
            <form
              onSubmit={handleSubmit(handleAddNewCourse as any)}
