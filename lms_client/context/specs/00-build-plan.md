...
1. **[01: My Courses — List Page Redesign](./01-my-courses-list-redesign.md)** — visual redesign of `/my-courses` to match the `/courses` catalog's card/grid style. Implemented.
2. **[02: My Course Detail / Player Page Redesign](./02-my-course-detail-redesign.md)** — visual redesign of `/my-courses/[id]` (header, visible progress, card surfaces, consistent module-list styling). Implemented.
