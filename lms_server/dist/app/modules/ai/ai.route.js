...
router.get("/review-summary/:courseId", rateLimiter_1.aiLimiter, ai_controller_1.aiController.getReviewSummary);
// ! for getting AI course recommendations based on a learning goal
router.post("/course-advisor", rateLimiter_1.aiLimiter, (0, validateRequest_1.default)(ai_validation_1.aiValidation.courseAdvisorSchema), ai_controller_1.aiController.getCourseAdvice);
