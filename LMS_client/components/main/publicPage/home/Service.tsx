  ...
  return (
    <div className="ServiceContainer py-8 bg-gray-100 ">
      <Wrapper className="ServiceWrapper">
        <h1 className="  text-center  text-prime-100 font-medium  text-xl sm:text-2xl md:text-3xl ">
          Our Services
        </h1>
        <h2 className=" text-center pt-4 font-medium text-lg sm:text-xl md:text-2xl ">
          Delivering Interactive & Skill-Focused Online Learning
        </h2>

        <div className="servicesSection pt-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 ">
          {servicesData &&
